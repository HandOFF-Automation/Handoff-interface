...
const textIcon = <span style={{ fontFamily: 'var(--canvas-font-sans)', fontSize: 12, fontWeight: 800, lineHeight: 1 }}>NOT</span>

export default function NotNode({ label = 'Not', labelSegments, icon, selected = false, activeConnectorSide = null, invalidConnectorSide = null, connectedConnectorSides = [], onConnectorPointerDown, onMeasure }: NotNodeProps) {
