...
export default function ScaleOutNode({ label = 'Scale Out', labelSegments, icon, selected = false, activeConnectorSide = null, onConnectorPointerDown, onMeasure }: ScaleOutNodeProps) {
