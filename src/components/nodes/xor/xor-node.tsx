...
const textIcon = <span style={{ fontFamily: 'var(--canvas-font-sans)', fontSize: 10, fontWeight: 800, lineHeight: 1 }}>1/1</span>

export default function XorNode({ label = 'Only One', labelSegments, icon, selected = false, activeConnectorSide = null, invalidConnectorSide = null, connectedConnectorSides = [], onConnectorPointerDown, onMeasure }: XorNodeProps) {
