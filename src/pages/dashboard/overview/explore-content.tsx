...
type ExploreAssetFilterId = 'all' | 'crypto' | 'stock'
...
const exploreDataset = {
  ...
  strategies: [
    ...
    { id: 'strategy-4', title: 'Big Tech Rotation', totalApr: '+0.74%', tokens: ['AAPL', 'MSFT', 'NVDA'] },
    { id: 'strategy-5', title: 'AI Infrastructure Basket', totalApr: '+1.16%', tokens: ['NVDA', 'MSFT', 'GOOGL'] },
    { id: 'strategy-6', title: 'Volatility Capture', totalApr: '+0.91%', tokens: ['TSLA', 'NVDA', 'AMZN'] },
  ...
  rows: [
    { id: 'token-1', symbol: 'BTC', name: 'Bitcoin', price: '$68,421.22', change24h: '+1.39%', marketCap: '$1.34T', volume: '$28.4B', chartValues: [58, 60, 61, 63, 62, 66, 68], filterCategory: 'gainers', assetType: 'crypto' },
    { id: 'token-2', symbol: 'ETH', name: 'Ethereum', price: '$3,542.10', change24h: '-1.39%', marketCap: '$425.7B', volume: '$16.8B', chartValues: [70, 69, 67, 66, 64, 63, 61], filterCategory: 'losers', assetType: 'crypto' },
    { id: 'token-3', symbol: 'SOL', name: 'Solana', price: '$178.14', change24h: '+2.18%', marketCap: '$82.1B', volume: '$6.3B', chartValues: [38, 40, 39, 43, 46, 48, 51], filterCategory: 'gainers', assetType: 'crypto' },
    { id: 'token-4', symbol: 'USDC', name: 'USD Coin', price: '$1.00', change24h: '+0.01%', marketCap: '$32.9B', volume: '$5.4B', chartValues: [50, 50, 50, 50, 50, 50, 50], filterCategory: 'stable', assetType: 'crypto' },
    { id: 'token-5', symbol: 'ARB', name: 'Arbitrum', price: '$1.27', change24h: '-0.84%', marketCap: '$4.3B', volume: '$418M', chartValues: [62, 61, 60, 59, 58, 58, 57], filterCategory: 'losers', assetType: 'crypto' },
    { id: 'token-6', symbol: 'MNT', name: 'Mantle', price: '$1.09', change24h: '+3.42%', marketCap: '$3.6B', volume: '$214M', chartValues: [24, 26, 28, 29, 33, 35, 39], filterCategory: 'gainers', assetType: 'crypto' },
    { id: 'stock-1', symbol: 'AAPL', name: 'Apple', price: '$211.26', change24h: '+1.24%', marketCap: '$3.23T', volume: '$58.4B', chartValues: [58, 59, 61, 62, 64, 66, 68], filterCategory: 'megacap', assetType: 'stock' },
    { id: 'stock-2', symbol: 'MSFT', name: 'Microsoft', price: '$447.81', change24h: '+0.82%', marketCap: '$3.33T', volume: '$41.7B', chartValues: [62, 62, 63, 64, 65, 66, 67], filterCategory: 'megacap', assetType: 'stock' },
    { id: 'stock-3', symbol: 'NVDA', name: 'NVIDIA', price: '$1,086.92', change24h: '+2.91%', marketCap: '$2.67T', volume: '$74.3B', chartValues: [44, 47, 49, 53, 57, 61, 66], filterCategory: 'gainers', assetType: 'stock' },
    { id: 'stock-4', symbol: 'AMZN', name: 'Amazon', price: '$183.54', change24h: '-0.44%', marketCap: '$1.91T', volume: '$29.8B', chartValues: [68, 67, 67, 66, 65, 64, 63], filterCategory: 'losers', assetType: 'stock' },
    { id: 'stock-5', symbol: 'GOOGL', name: 'Alphabet', price: '$176.38', change24h: '+0.68%', marketCap: '$2.18T', volume: '$22.1B', chartValues: [52, 53, 54, 54, 55, 56, 57], filterCategory: 'megacap', assetType: 'stock' },
    { id: 'stock-6', symbol: 'TSLA', name: 'Tesla', price: '$177.29', change24h: '-1.12%', marketCap: '$565.8B', volume: '$31.4B', chartValues: [71, 69, 67, 64, 62, 60, 58], filterCategory: 'losers', assetType: 'stock' },
  ] as ExploreRow[],
}
